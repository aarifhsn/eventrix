...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_organizer_form'])) {
    try {
        ...
        $statement = $pdo->prepare("INSERT INTO organizers (name, designation, bio, address, email, phone, website, facebook, twitter, linkedin, instagram, photo) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)");
        $statement->execute([
            $_POST['name'],
            $_POST['designation'],
            $_POST['bio'],
        ...
        header("location: " . ADMIN_URL . "organizer-add.php");
        exit;
    }
}

// Fetch all schedule days
$organizers = fetchAll($pdo, 'organizers', 'id ASC');
?>
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary"
                                        name="add_organizer_form">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
